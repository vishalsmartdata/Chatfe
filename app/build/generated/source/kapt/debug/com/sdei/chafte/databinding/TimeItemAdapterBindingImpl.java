...
public class TimeItemAdapterBindingImpl extends TimeItemAdapterBinding implements com.sdei.chafte.generated.callback.OnClickListener.Listener {
    ...
    public TimeItemAdapterBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private TimeItemAdapterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.LinearLayout) bindings[0]
            , (android.widget.TextView) bindings[1]
            );
        this.lnTimeItem.setTag(null);
        this.textView5.setTag(null);
        setRootTag(root);
        // listeners
        mCallback5 = new com.sdei.chafte.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((com.sdei.chafte.model.BottomMenu) variable);
        }
    ...
    public void setModel(@Nullable com.sdei.chafte.model.BottomMenu Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.sdei.chafte.model.BottomMenu model = mModel;
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.lnTimeItem.setOnClickListener(mCallback5);
        }
        if ((dirtyFlags & 0x9L) != 0) {
            // api target 1
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (callbackJavaLangObjectNull) {
            ...
            callback.onItemClick(lnTimeItem, position);
        }
    }
    // dirty flag
