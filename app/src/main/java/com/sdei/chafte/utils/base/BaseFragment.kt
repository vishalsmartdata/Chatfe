...
abstract class BaseFragment<dataBinding : ViewDataBinding, viewModel : ViewModel> : Fragment() {
     ...
     */
    fun setUpVM(fragment: AppCompatActivity, obj: ViewModel): viewModel {
    ...
    fun navigateActivity(activity: AppCompatActivity, bundle: Bundle?) {
        baseActivity.navigateActivity(activity, bundle)
    }
    ...
    fun openFragmentReplaceNoAnimWithBundle(id: Int, fragment: Fragment, tag: String, addToBack: Boolean, bundle: Bundle?) {
        baseActivity.openFragmentReplaceNoAnimWithBundle(id, fragment, tag, addToBack,bundle)
    }
