...
import com.sdei.chafte.databinding.FragmentFouthSlideBinding
...
class FourthSlideFragment : BaseFragment<FragmentFouthSlideBinding, IntroVm>() {
    override val layoutId: Int
        get() = R.layout.fragment_fouth_slide
    override var viewModel: IntroVm
        get() = setUpVM(activity as AuthenticationActivity, IntroVm(baseActivity.application))
        set(value) {}
    override var binding: FragmentFouthSlideBinding
        get() = setUpBinding()
        set(value) {}
